...
# copied from the sktime utility of the same names
...
SklearnBaseEstimator = _safe_import("sklearn.base.BaseEstimator")
ClassifierMixin = _safe_import("sklearn.base.ClassifierMixin")
ClusterMixin = _safe_import("sklearn.base.ClusterMixin")
RegressorMixin = _safe_import("sklearn.base.RegressorMixin")
TransformerMixin = _safe_import("sklearn.base.TransformerMixin")
GridSearchCV = _safe_import("sklearn.model_selection.GridSearchCV")
RandomizedSearchCV = _safe_import("sklearn.model_selection.RandomizedSearchCV")
Pipeline = _safe_import("sklearn.pipeline.Pipeline")
...
def is_sklearn_estimator(obj):
    ...
    return issubclass(obj, SklearnBaseEstimator)
