...
class OpenMLRun(OpenMLBase):
    ...
    def publish(self) -> OpenMLRun:
        ...
        result = api_context.backend.runs.publish(path="run", files=file_elements)
        self.run_id = result
        return self
    ...
    def push_tag(self, tag: str) -> None:
        ...
        api_context.backend.runs.tag(self.run_id, tag)
    ...
    def remove_tag(self, tag: str) -> None:
        ...
        api_context.backend.runs.untag(self.run_id, tag)
