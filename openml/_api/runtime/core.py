...
if TYPE_CHECKING:
    from openml._api.resources.base import DatasetsAPI, StudiesAPI, TasksAPI


class APIBackend:
    def __init__(self, *, datasets: DatasetsAPI, tasks: TasksAPI, studies: StudiesAPI):
