...
class TestEvaluationFunctions(TestBase):
    ...
    def _check_list_evaluation_setups(self, **kwargs):
        ...
        self.assertSequenceEqual(  # noqa: PT009
        ...
        self.assertSequenceEqual(evals_setups["run_id"].tolist(), evals["run_id"].tolist())  # noqa: PT009
        ...
        for _index, row in evals_setups.iterrows():
            ...
            self.assertSequenceEqual(sorted(list1), sorted(list2))  # noqa: PT009
        return evals_setups
