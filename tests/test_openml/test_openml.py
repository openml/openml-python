...
class TestInit(TestBase):
    ...
    def test_populate_cache(
        ...
        for argument, fixture in zip(run_mock.call_args_list, [(7,), (8,)], strict=False):
            assert argument[0] == fixture

        assert flow_mock.call_count == 2
        for argument, fixture in zip(flow_mock.call_args_list, [(5,), (6,)], strict=False):
            assert argument[0] == fixture
        ...
        for argument, fixture in zip(task_mock.call_args_list, [(1,), (2,)], strict=False):
            assert argument[0] == fixture
