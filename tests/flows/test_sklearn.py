...
class TestSklearn(unittest.TestCase):
    ...
    def test_serialize_model_with_subcomponent(self):
        ...
        self.assertIsInstance(serialization.parameters['base_estimator'],
                              OpenMLFlow)
    ...
    def test_serialize_pipeline(self):
        ...
        self.assertEqual(serialization.parameters['steps'][0][0], 'scaler')
        self.assertIsInstance(serialization.parameters['steps'][0][1],
                              OpenMLFlow)
        self.assertEqual(serialization.parameters['steps'][1][0],
                         'dummy')
        self.assertIsInstance(serialization.parameters['steps'][1][1],
                              OpenMLFlow)

        # Checking the sub-component
        self.assertEqual(len(serialization.components), 2)
        self.assertEqual(serialization.parameters['steps'][0][1],
                         serialization.components['steps__scaler'])
        self.assertEqual(serialization.parameters['steps'][1][1],
                         serialization.components['steps__dummy'])
    ...
    def test_serialize_resampling(self):
        ...
        deserialized = self.converter.deserialize_object(serialized)
        # Best approximation te get_params()
