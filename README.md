...
Get a [task](https://docs.openml.org/concepts/tasks/) for [supervised classification for credit-g](https://www.openml.org/search?type=task&id=31&source_data.data_id=31):
